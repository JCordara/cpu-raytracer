...
set ruler
set runtimepath=~/.vim,~/.vim/pack/yuttie/start/comfortable-motion,~/.vim/pack/tpope/start/surround,~/.vim/pack/tpope/start/repeat,~/.vim/pack/tpope/start/fugitive,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=10
set shiftwidth=4
set showcmd
set showmatch
...
silent only
silent tabonly
cd ~/Projects/Rendering/cpu_raytracer
...
badd +1 main.cpp
badd +36 gen_bmp.cpp
badd +4 vector_base.h
badd +1 vec3f.cpp
badd +1 vec3f.h
badd +1 test_vec3f.hpp
badd +0 test_framework.h
argglobal
%argdel
$argadd main.cpp
set stal=2
